...
{
    public class AcessoRapido : ViewComponent
    {
        ...
        public AcessoRapido(IModuloService moduloService,
        ...
        public IViewComponentResult Invoke()
        {
            ...
            foreach (var modulo in selectMenuModulo)
            {
                ...
                selectMenuAcao = MenuService.GetList((Guid)modulo.id, Guid.Empty, new Guid(id), null).ToList();
