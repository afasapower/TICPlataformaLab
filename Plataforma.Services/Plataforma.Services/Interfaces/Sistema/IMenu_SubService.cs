...
{
    /// <summary>
    /// Inteface de IMenu_SubService
    /// </summary>
    public interface IMenu_SubService : IServiceBase<Menu_Sub>
    {
        /// <summary>
        ...
        /// <returns></returns>
        IEnumerable<Menu_Sub> GetList(Guid id_menu, string tipo = "", Parametros_Busca_Grid parametros_Busca_Grid = null);
        ...
        /// <param name="parametros_Busca_Grid"></param>
        /// <returns></returns>
        IEnumerable<Menu_Sub> GetListPaginaDisponivel(Guid id_menu, string tipo = "", Parametros_Busca_Grid parametros_Busca_Grid = null);
    }
}